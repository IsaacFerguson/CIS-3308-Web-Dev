var castleMods = {}; // Update Solutioin Spring 2022
...
(function () {  // This is an IIFE, an immediately executing function.
    ...
    var fields = [
        {
            fieldName: "castleTableId",
            prompt: "Castle Id",
            disabled: true
        },
        {
            fieldName: "castleName",
            prompt: "castle Name"
        },
        {
            fieldName: "imageURL",
        ...
        {
            fieldName: "timeOnMarket",
            prompt: "Time on Market"
        },
        {
            fieldName: "dateBuilt",
            prompt: "Date Built"
        ...
        {
            fieldName: "peopleInterested",
            prompt: "People Interested"
        },
        {
    ...
    castleMods.insert = function () {
        ...
        userEditArea.button.onclick = function () {  // INSERT SAVE
            ...
            ajax("webAPIs/insertCastleAPI.jsp?jsonData=" + urlParams, reportInsert, userEditArea.formMsg);
        ...
        return component;
    }; // registerContent.insert
    
    castleMods.update = function (webUserId) {

        userEditArea.areaTitle.innerHTML = "Update Castle";
        userEditArea.blankInputs();
        userEditArea.button.innerHTML = "Update Save";
        userEditArea.formMsg.innerHTML = ""; // wipe out any old message

        console.log("Castle.update called with webUserId " + webUserId);

        // get the web user record with the given webUserId
        ajax("webAPIs/getCastleByIdAPI.jsp?castleId=" + webUserId, gotRecordById, userEditArea.formMsg);
        ...
        userEditArea.button.onclick = function () { // Update Save
            ...
            ajax("webAPIs/updateCastleAPI.jsp?jsonData=" + urlParams, reportUpdate, userEditArea.formMsg);
